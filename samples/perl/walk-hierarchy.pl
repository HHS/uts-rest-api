...
##uncomment one of the paths below to traverse (recursively) the hierarchy of a source vocabulary.

#my $path =  "/rest/content/".$version."/source/".$source."/".$id."/children";
#my $path =  "/rest/content/".$version."/source/".$source."/".$id."/ancestors";
#my $path =  "/rest/content/".$version."/source/".$source."/".$id."/parents";
my $path =  "/rest/content/".$version."/source/".$source."/".$id."/descendants";
